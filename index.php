...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-7">
            ...
            ?>
            <div class="alert alert-danger alert-dismissible fade shown" role="alert">
            ...
            ?>
            <div class="alert alert-succes alert-dismissible fade shown" role="alert">
                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="text-succes" href="editar.php?codigo=<?php echo $dato->id; ?>"><i class="bi bi-pencil-square"></i></a></td>
                                <td><a onclick="return confirm('Estas seguro de eliminar?');" class="text-danger"
                            href="elimnar.php?codigo=<?php echo $dato->id; ?>"><i class="bi bi-trash"></i></a></td>
                            </tr>
        ...
        <div class="card">
            ...
            <form classe="p-4" method="POST" action="registrar.php">
                <div class="mb=3">
